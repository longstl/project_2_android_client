...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //validate
        validate.addValidation(this,R.id.edtPhone,"^\\+(?:[0-9] ?){6,14}[0-9]$",R.string.validate_phone);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate.validate()) {
                    ...
                    try {
                        Account account = new Account(phone.toString().trim(), mySecurePassword.toString().trim(), salt.toString().trim(), fullname.toString().trim(), email.toString().trim(), radioGenderButton.toString().trim());
